...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "input_path",
        help=(
            "Path to the `.pickle` file containing scores as generated by AlphaFold."
        ),
    )
    ...
    with (
        ...
        output_scores = {"pae": scores["predicted_aligned_error"].tolist()}

        try:
            output_scores["max_pae"] = scores["max_predicted_aligned_error"].item()
        except KeyError:
            pass
